...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { birth_date: @child.birth_date, name: @child.name, pform_id: @child.pform_id } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { birth_date: @child.birth_date, name: @child.name, pform_id: @child.pform_id } }
